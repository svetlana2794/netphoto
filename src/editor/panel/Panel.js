...
if (options.target instanceof Rect ||
...
<button className="button" onClick={(e) => {handleAdd(addRect, e)}}>Прямоугольник</button>
<button className="button" onClick={(e) => {handleAdd(addCircle, e)}}>Круг</button>
<button className="button" onClick={(e) => {handleAdd(addTriangle, e)}}>Треугольник</button>
<button className="button" onClick={(e) => {handleAdd(addText,e)}}>Текст</button>
<button className="button" onClick={handleDraw}>Кисть</button>
<button onClick={handleSave} className="save">Сохранить изображение</button>
