...
<input type="checkbox" value={!checkBold ? "bold" : "normal"} name="fontWeight" checked={checkBold} onChange={(e) => {
setCheckBold(!checkBold);
handleText(e);
}}/>Полужирный
</label>
<label style={{backgroundColor: checkItalic ? '#1949FF' : '#6988FF'}}>
<input type="checkbox" value={!checkItalic ? "italic" : "normal"} name="fontStyle" checked={checkItalic} onChange={(e) => {
...
<input type="checkbox" name="underline" checked={checkUnder} onChange={(e) => {
setCheckUnder(!checkUnder);
handleDecor(e)
}}/>Подчеркнутый
</label>
<label style={{backgroundColor: checkThrough ? '#1949FF' : '#6988FF'}}>
<input type="checkbox" name="linethrough" checked={checkThrough} onChange={(e) => {
setCheckThrough(!checkThrough);
handleDecor(e);
}}/>Зачеркнутый
</label>
<label style={{backgroundColor: checkOver ? '#1949FF' : '#6988FF'}}>
<input type="checkbox" name="overline" checked={checkOver} onChange={(e) => {
